module_name = 'PicoA_v08.py'

import DriveTrainRemote_v10 as DriveTrain
import GPIOPico_v15 as GPIOPico
import RemoteControl_v09 as RemoteControl
import NeoPixel_v01 as NeoPixel
import utime
...
class ThisRedLED(GPIOPico.LED):
    def __init__(self):
        super().__init__('Red', 13)

class ThisGreenLED(GPIOPico.LED):
    def __init__(self):
        super().__init__('Green', 14)

class ThisBlueLED(GPIOPico.LED):
    def __init__(self):
        super().__init__('Blue', 15)
